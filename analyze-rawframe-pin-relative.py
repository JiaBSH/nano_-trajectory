...
Pin-relative analysis is controlled by pin_reference_enabled in
analyze-rawframe.py. Keep this file so old commands that run
analyze-rawframe-pin-relative.py still work.
"""
